...
def seed(repo):
    rows=[
      ...
      item("Emma communication style","Emma is warm, compassionate, gentle, validating and creates emotional safety before advice.",target="EMMA",category="PERSONA",priority="HIGH",authority=95,components=["Emma"]),
      item("Ben communication style","Ben is calm, grounded, practical, clear and action-oriented without aggressive coaching.",target="BEN",category="PERSONA",priority="HIGH",authority=95,components=["Ben"]),
